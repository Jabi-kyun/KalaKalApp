...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  // ✅ SAFE HELPER TO GET INITIAL LETTER WITHOUT CRASHING
  String getSafeInitial(String? text) {
  ...
  Future<String?> _convertImageToBase64() async {
    ...
    try {
      return base64Encode(await _imageFile!.readAsBytes());
    } catch (e) {
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                    ...
                    CircleAvatar(
                      ...
                      backgroundImage: _imageFile != null
                          ...
                          : (_currentProfileBase64 != null &&
                                    _currentProfileBase64!.isNotEmpty
                                ? MemoryImage(
                      ...
                      child:
                          _imageFile == null &&
                              (_currentProfileBase64 == null ||
                                  _currentProfileBase64!.isEmpty)
                          ? Text(
                              getSafeInitial(_nameController.text),
                              style: TextStyle(
                                fontSize: 40,
              ...
              const SizedBox(height: 8),
              Text(
                'Collectors within 1km of this area will be notified when you post.',
                style: TextStyle(fontSize: 12, color: Colors.grey.shade600),
              ),
              const SizedBox(height: 8),
